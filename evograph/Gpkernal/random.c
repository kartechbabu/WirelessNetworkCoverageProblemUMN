...
//HJJ
/* Generation of random value between lower- and upperbound */
double random_value(double lowerbound, double upperbound)
{
  double value;
  value=((double)(rand()%10000)/10000.0)*(upperbound-lowerbound)+lowerbound;
  return(value);
}
